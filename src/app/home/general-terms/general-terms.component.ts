...
export class GeneralTermsComponent implements OnInit {
  ...
  companyInfo: {
    ...
    name: '',
    adress: 'гр. Русе',
    email: 'admin@racefanatic.app',
    updatedAt: '02.02.2024 г.',
  };
  ...
  privacyPolicy: { title: string; titleColor: string; content: string[] }[] = [
    ...
    },
    {
      ...
      content: [
        ...
        '4.3. Ако имате въпроси относно защитата на личната информация или искате да упражните своите права по силата на GDPR, моля, свържете се с нас на admin@racefanatic.app',
      ],
    },
    {
      title: '5. Промени',
